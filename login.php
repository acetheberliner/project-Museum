...
<body style="font-family: 'Poppins', sans-serif; background: linear-gradient(rgba(0, 0, 0, 0.37), rgba(0, 0, 0, 0.36)), url('https://images.unsplash.com/photo-1579541671172-43429ce17aca?q=80&w=2065&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D') center/cover no-repeat; color: #333; height: 100vh; display: flex; align-items: center; justify-content: center;">
